  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6 lg:mb-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl lg:text-4xl font-semibold text-gray-900 mb-2 tracking-tight">Patients</h1>
          <p className="text-gray-500 text-sm lg:text-lg">Manage patient records and information.</p>
        </div>
